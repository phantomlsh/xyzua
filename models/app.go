...
type App struct {
	Id       int    `orm:"column(id);auto" description:"appid"`
	Appname  string `orm:"column(appname);size(64)" description:"application name"`
	Secret   string `orm:"column(secret);size(64)" description:"application secret"`
	Callback string `orm:"column(callback);size(512)" description:"callback url"`
}
